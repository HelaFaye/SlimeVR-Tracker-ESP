...
{
    int bmiThreshold = BMI160::getFreefallDetectionThreshold();
...
void CurieIMUClass::setFreefallDetectionThreshold(float threshold)
{
    ...
    BMI160::setFreefallDetectionThreshold(bmiThreshold);
}

float CurieIMUClass::getShockDetectionThreshold()
{
    int bmiThreshold = BMI160::getShockDetectionThreshold();
    float step;
    float min;
...
void CurieIMUClass::setShockDetectionThreshold(float threshold)
{
    ...
    BMI160::setShockDetectionThreshold(bmiThreshold);
}

float CurieIMUClass::getMotionDetectionThreshold()
{
    int bmiThreshold = BMI160::getMotionDetectionThreshold();
    float step;
...
void CurieIMUClass::setMotionDetectionThreshold(float threshold)
{
    ...
    BMI160::setMotionDetectionThreshold(bmiThreshold);
}

float CurieIMUClass::getZeroMotionDetectionThreshold()
{
    int bmiThreshold = BMI160::getZeroMotionDetectionThreshold();
    float step;
...
void CurieIMUClass::setZeroMotionDetectionThreshold(float threshold)
{
    ...
    BMI160::setZeroMotionDetectionThreshold(bmiThreshold);
}

float CurieIMUClass::getTapDetectionThreshold()
{
    int bmiThreshold = BMI160::getTapDetectionThreshold();
    float step;
    float min;
...
void CurieIMUClass::setTapDetectionThreshold(float threshold)
{
    ...
    BMI160::setTapDetectionThreshold(bmiThreshold);
}
...
{
    int bmiDuration = BMI160::getFreefallDetectionDuration();
...
void CurieIMUClass::setFreefallDetectionDuration(float duration)
{
    ...
    BMI160::setFreefallDetectionDuration(bmiDuration);
}
...
int CurieIMUClass::getShockDetectionDuration()
{
    ...
    switch (BMI160::getShockDetectionDuration()) {
...
void CurieIMUClass::setShockDetectionDuration(int duration)
{
    ...
    BMI160::setShockDetectionDuration(bmiDuration);
}

float CurieIMUClass::getMotionDetectionDuration()
{
    int bmiDuration = BMI160::getMotionDetectionDuration();
...
void CurieIMUClass::setMotionDetectionDuration(float duration)
{
    ...
    BMI160::setMotionDetectionDuration(bmiDuration);
}
...
float CurieIMUClass::getZeroMotionDetectionDuration()
{
    ...
    switch (BMI160::getZeroMotionDetectionDuration()) {
...
void CurieIMUClass::setZeroMotionDetectionDuration(float duration)
{
    ...
    BMI160::setZeroMotionDetectionDuration(bmiDuration);
}
...
void CurieIMUClass::setTapShockDuration(int duration)
{
    ...
    BMI160::setTapShockDuration(bmiDuration);
}
...
void CurieIMUClass::setTapQuietDuration(int duration)
{
    ...
    BMI160::setTapQuietDuration(bmiDuration);
}
...
int CurieIMUClass::getDoubleTapDetectionDuration()
{
    ...
    switch (BMI160::getDoubleTapDetectionDuration()) {
...
void CurieIMUClass::setDoubleTapDetectionDuration(int duration)
{
    ...
    BMI160::setDoubleTapDetectionDuration(bmiDuration);
}
...
{
    return (CurieIMUStepMode)BMI160::getStepDetectionMode();
}

void CurieIMUClass::setStepDetectionMode(int mode)
{
    BMI160::setStepDetectionMode((BMI160StepMode)mode);
}
 ...
 *  the relevant API functions from the BMI160 base class.
 */
